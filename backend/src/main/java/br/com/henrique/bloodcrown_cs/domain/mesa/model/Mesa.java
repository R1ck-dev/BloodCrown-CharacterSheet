...
/**
 * Raiz do agregado Mesa (tabletop compartilhado). Dona do mapa, do grid, dos tokens e da
 * lista de participantes. Toda regra de acesso/posse mora aqui como método de domínio;
 * a use case só orquestra e persiste. IDs são gerados no domínio (UUID), sem @GeneratedValue.
 */
@Getter
public class Mesa {
    ...
    public Mesa(String id, String nome, String donoUserId, String mapaUrl, Grid grid,
                List<Token> tokens, Set<String> participantes, String codigoConvite) {
    ...
    public static Mesa criar(String nome, String donoUserId) {
        return new Mesa(null, nome, donoUserId, null, new Grid(), new ArrayList<>(),
                new LinkedHashSet<>(), gerarCodigoConvite());
    }
