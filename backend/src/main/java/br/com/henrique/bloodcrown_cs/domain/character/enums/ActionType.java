...
/**
 * Tipos de ação que uma habilidade pode consumir do pool por turno do personagem.
 * Hierarquia D&D-like: STANDARD pode substituir BONUS ou MOVEMENT;
 * BONUS pode substituir MOVEMENT; REACTION isolada; FREE não consome.
 */
public enum ActionType {
     ...
     * minúsculas e variantes comuns. Cai pra STANDARD se não reconhecido.
     */
    private static final Map<String, ActionType> LEGACY = Map.ofEntries(
    ...
    /**
     * Hierarquia D&D-like: define se `this` (ação que o usuário quer gastar)
     * pode cobrir uma habilidade que exige `required`.
     * REACTION e FULL não são substituídos nem substituem outros.
     */
    public boolean canSubstitute(ActionType required) {
