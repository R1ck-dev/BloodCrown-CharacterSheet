...
/** Mostra/esconde o nome embaixo de um token no tabuleiro. Colaborativo. */
@Service
@RequiredArgsConstructor
public class DefinirNomeVisivelTokenUseCase {
    ...
    public Mesa execute(String mesaId, String userId, String tokenId, boolean visivel) {
        ...
        mesa.definirNomeVisivel(tokenId, visivel, userId);
